...
Finite mixture models, hidden state estimation, and structural-break detection for systems whose data-generating process is non-stationary and partially observed.

</td>
<td width="50%" valign="top">

#### &nbsp;◇&nbsp; Macro-Financial Systems
Systemic banking fragility, sovereign-balance-sheet stress, cross-country contagion, and the institutional indicators that precede regime change.
...
Long-context reasoning systems, foundation-model evaluation under distribution shift, and the infrastructure layer of computational statecraft.

</td>
<td width="50%" valign="top">

#### &nbsp;◇&nbsp; Computational Statecraft
Digital twins for national resilience, policy stress-testing, and the synthesis of econometric, institutional, and geopolitical signals into actionable surfaces.
...
A macro-financial **digital twin** for national resilience research. Stratum ingests econometric, institutional, and macro-prudential signals to model **nonlinear interdependencies** between fiscal, financial, and external sectors — producing interpretable what-if surfaces for policy stress-testing.

<table border="0">
<tr><td valign="top" width="3%">›</td><td>Simulates <b>systemic-risk propagation</b> across balance-sheet, sovereign-debt, and external-account channels.</td></tr>
<tr><td valign="top" width="3%">›</td><td>Stress-tests <b>policy scenarios</b> under heterogeneous regime assumptions.</td></tr>
<tr><td valign="top" width="3%">›</td><td>Synthesizes <b>fragmented institutional signals</b> into a coherent state representation.</td></tr>
<tr><td valign="top" width="3%">›</td><td>Generates <b>interpretable counterfactuals</b> — not black-box forecasts, but auditable causal chains.</td></tr>
</table>

<br/>

### &nbsp;&nbsp;▸&nbsp; **Hidden Regimes of Financial Instability** &nbsp;&nbsp;<sub><i>doctoral-track research</i></sub>
...
<sub>EM · Panel Logit · Mixture Models</sub>
...
<sub>Digital twin · Policy simulation · Counterfactual inference</sub>
...
<sub>Geospatial · Sampling theory · Plotly</sub>
...
| **Statistician** | Center of Applied Statistics, BAU | End-to-end workflows · Cross-sectional and longitudinal inference |
| **Data Scientist** | metaSOFT | ML systems · Medical-imaging pipelines · Cloud deployment |
| **Teaching Assistant** | University of Szeged | Medical Statistics · R computing |
| **Independent Consultant** | Various | AI strategy · Foundation-model evaluation · LLM safety guardrails |
...
A biosensing platform achieving 5 nM sensitivity and simultaneous discrimination of Vaccinia and hepatitis B markers via fluorescence quenching.
...
<table border="0">
<tr>
<td valign="top" width="3%"><b>I.</b></td>
<td><b>Structure precedes prediction.</b> Before forecasting a system, identify the latent regime generating its data. A model that ignores its own conditioning will fail at the moment it matters.</td>
</tr>
<tr>
<td valign="top" width="3%"><b>II.</b></td>
<td><b>Instability is informative.</b> Crises are not noise around equilibrium — they are the only moments where the true topology of a system becomes legible.</td>
</tr>
<tr>
<td valign="top" width="3%"><b>III.</b></td>
<td><b>Interpretability is non-optional.</b> A model whose mechanism cannot be audited cannot inform policy, allocate sovereign capital, or be trusted under adversarial conditions.</td>
</tr>
<tr>
<td valign="top" width="3%"><b>IV.</b></td>
<td><b>Distribution shift is the default.</b> The world that produced the training data is not the world the model will operate in. Transportability is the first-class problem, not an afterthought.</td>
</tr>
<tr>
<td valign="top" width="3%"><b>V.</b></td>
<td><b>Sovereignty is computational.</b> The capacity to model one's own institutional, fiscal, and informational topology is no longer optional infrastructure — it is the precondition for strategic autonomy.</td>
</tr>
</table>
...
<sub><i>Open to research partnerships, advisory engagements, and sovereign-systems collaborations.</i></sub>
